...
char packet[] = {
    ...
    ,
...
void *sending_fucntion()
{
    ...
    double time_require = (double)sizeof(packet) * 8.0 * 1e-9 / (SENDING_RATE_IN_GIGA / NUM_SEND_THREAD);
    while (1)
    {
        /*
        ...
        if (time_taken >= 0)
        {
            ...
            time_taken += (time_taken + (start.tv_nsec - previous.tv_nsec)) * 1e-9;
        ...
        {
            time_taken = 0;
            if (time_taken > time_require)
                time_taken += time_taken - time_require;
...
int main()
{
    ...
    {
        pthread_create(&p_thread[i], NULL, sending_fucntion, NULL);
    }
