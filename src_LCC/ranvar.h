...
double minCDF_ = 0 ;		// min value of the CDF (default to 0)
double maxCDF_ = 1;		// max value of the CDF (default to 1)
int interpolation_ = 1; // how to interpolate data (INTER_DISCRETE...)
int numEntry_ = INTER_INTEGRAL;		// number of entries in the CDF table
int maxEntry_ = 32;		// size of the CDF table (mem allocation)
struct CDFentry *table_= 0;   // CDF table of (val_, cdf_)
